...
export const DATA = {
  ...
  locationLink: "",
  description:
    "+33 6 02 22 78 25 | Aix-Les-Bains, France",
  summary:
    "Pour découvrir un portfolio plus complet, scannez le QR Code. J'ai choisi de quitter l'école pour me concentrer sur des apprentissages concrets en gestion de communautés, programmation et entrepreneuriat. Après une tentative de retour aux études en programmation, j'ai abandonné en raison de la durée du cursus. Aujourd'hui, je vise à renforcer mes compétences en relations humaines, commerce, ainsi qu'en gestion d'équipes et d'entreprises.",
  avatarUrl: "/me.png",
  skills: [
    "Négociation",
    "Gestion du temps",
