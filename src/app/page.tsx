...
import { Avatar, AvatarFallback, AvatarImage, AvatarImageQRCode, AvatarQRCode } from "@/components/ui/avatar";
          ...
          <div className="gap-2 flex justify-between">
            ...
            <div style={{marginTop: -12}}>
              <BlurFade delay={BLUR_FADE_DELAY}>
                <AvatarQRCode className="size-28">
                  <AvatarImageQRCode alt={DATA.name} src={DATA.avatarUrl} />
